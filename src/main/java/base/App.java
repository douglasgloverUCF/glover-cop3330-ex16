...
Instead of hard-coding the driving age in your program logic, research driving ages for various countries and create a lookup table for
the driving ages and countries. Prompt for the age, and display which countries the user can legally drive in.
 */
public class App {
    ...
    {
        String check = age < 16 ? "not old": "old";
        System.out.print("You are "+ check + " enough to legally drive.");
    }
}
